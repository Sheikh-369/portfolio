...
//           style={{
//             background:
//               (project as any).gradient ||
//               `linear-gradient(135deg, ${project.color}, #ffffff22)`
//           }}
//         >
//           {(project as any).icon ? (project as any).icon : null}
//         </div>
...
//             <span className="w-12 h-12 rounded-full flex items-center justify-center border-2 border-white">
