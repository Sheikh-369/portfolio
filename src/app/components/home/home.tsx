    ...
    <div>
      ...
      <div className="lg:px-16 px-4 pb-4 h-full flex flex-col sm:flex-row sm:items-center mt-10 sm:mt-0 text-white">
        ...
        <div className="w-full flex flex-col z-10">
          ...
          <h4 className="text-rose-500 mt-4 lg:text-2xl xl:3xl">--FullStack Developer</h4>
          ...
          <div>
            <button className="mt-6 px-6 py-1 bg-rose-500 text-lg text-white rounded-sm lg:text-2xl">
              Get In Touch
            </button>
          </div>
        </div>
